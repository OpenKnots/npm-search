...
export const metadata: Metadata = {
  title: 'npm search - Search and browse npm packages',
  description: 'Search, explore, and discover npm packages with detailed metadata, dependency trees, and version history.',
  icons: {
    icon: [
      {
